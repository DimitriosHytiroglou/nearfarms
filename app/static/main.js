...
$(".update_col").on('click', function() {
	...
	$('#product_table').append("<tr> <td class='product_col'><input value="+product+"></td> <td class='type_col'><input value="+type+"></td> <td class='subtype_col'><input type="+subtype+"/></td> <td class='quantity_col'><input type="+quantity+"/></td> <td class='price_col'><input type="+price+"/></td> <td class='image_col'><input type="+image+"/></td> <td class='submit_col'> <button class='submit_button'> Submit</button></td> </tr>");
