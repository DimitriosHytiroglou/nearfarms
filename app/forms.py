...
class NewProducerForm(Form):
    producer_name = StringField('producerName', validators=[DataRequired()])    # John Farmer Farms LLC
...
class TripForm(Form):
    ...
    for friend in friends:
        value = str(friend['First'])+' '+str(friend['Last'])
        friendChoices.append((value,value))
